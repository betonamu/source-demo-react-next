...
export const actions = {
    ...
    showLoadingFullScreen: createAction(actionTypes.SHOW_LOADING_FULLSCREEN, requestType => requestType),
    hideLoadingFullScreen: createAction(actionTypes.HIDE_LOADING_FULLSCREEN, requestType => requestType)
}
